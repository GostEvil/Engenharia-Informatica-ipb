...
const ALL_QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      "quando o esquema de enderecos de rede usa VLSM"
    ],
    correct: [2],
    multiple: false,
  ...
  {
    id: 131,
    question: "Qual comando deve ser usado para configurar o EIGRP para anunciar apenas a rede conectada a interface GigabitEthernet 0/1 com endereco IP 172.16.23.65 e mascara 255.255.255.192?",
    options: [
    ...
    correct: [0],
    multiple: false,
    explanation: "A mascara curinga 0.0.0.63 corresponde exatamente a uma sub-rede /26 (255.255.255.192 invertida = 0.0.0.63). O endereco de rede dessa sub-rede e 172.16.23.64, e a mascara curinga 0.0.0.63 garante que apenas essa sub-rede especifica seja anunciada pelo EIGRP, sem incluir as outras sub-redes /26 vizinhas."
  },
  {
    id: 132,
    question: "Quais sao duas razoes para instalar um unico switch de configuracao fixa de 48 portas em vez de dois switches de 24 portas em um armario de cabeamento que serve duas salas de aula? (Escolha duas.)",
    options: [
      "mais portas disponiveis para dispositivos finais",
      "mais energia fornecida para cada porta",
      "velocidades de uplink mais altas",
      "requisitos reduzidos de energia e espaco",
      "numero reduzido de VLANs/dominios de broadcast"
    ],
    correct: [0, 3],
    multiple: true,
    explanation: "Um unico switch de 48 portas oferece mais portas para dispositivos finais (pois dois switches de 24 portas consomem portas adicionais para interconexao entre eles). Alem disso, um unico switch requer menos energia e ocupa menos espaco fisico no rack em comparacao com dois switches separados, cada um precisando de sua propria fonte de energia e suporte."
  },
  {
    id: 133,
    question: "Quais sao tres caracteristicas de switches da camada de acesso que devem ser consideradas ao projetar uma rede? (Escolha tres.)",
    options: [
      "contencao de trafego de broadcast",
      "capacidade de failover",
      "taxa de encaminhamento (forwarding rate)",
      "densidade de portas (port density)",
      "Power over Ethernet (PoE)",
      "velocidade de convergencia"
    ],
    correct: [2, 3, 4],
    multiple: true,
    explanation: "A densidade de portas (numero de portas por switch), a taxa de encaminhamento (quantidade de dados que o switch processa por segundo) e o Power over Ethernet (capacidade de fornecer energia a dispositivos via cabo Ethernet) sao as principais caracteristicas de switches da camada de acesso a considerar no design de rede. Capacidade de failover, velocidade de convergencia e contencao de broadcast sao caracteristicas da camada de distribuicao."
  },
  {
    id: 134,
    question: "Em uma rede empresarial grande, quais duas funcoes sao executadas por roteadores na camada de distribuicao? (Escolha duas.)",
    options: [
      "conectar redes remotas",
      "fornecer Power over Ethernet para dispositivos",
      "conectar usuarios a rede",
      "fornecer seguranca de trafego de dados",
      "fornecer um backbone de rede de alta velocidade"
    ],
    correct: [0, 3],
    multiple: true,
    explanation: "Na camada de distribuicao, os roteadores conectam redes remotas (incluindo filiais e WAN) e fornecem seguranca de trafego de dados usando ACLs, politicas de QoS e outros mecanismos. A camada de nucleo fornece o backbone de alta velocidade. Switches da camada de acesso conectam usuarios a rede e fornecem PoE."
  },
  {
    id: 135,
    question: "Quais duas condicoes devem ser atendidas para formar um cluster com 5 pontos de acesso (APs)? (Escolha duas.)",
    options: [
      "O modo de clustering deve estar habilitado nos APs.",
      "Pelo menos dois controladores sao necessarios para formar o cluster.",
      "Os APs devem estar conectados no mesmo segmento de rede.",
      "Os APs devem ser configurados para usar diferentes modos de radio.",
      "Os APs devem usar nomes de cluster diferentes."
    ],
    correct: [0, 2],
    multiple: true,
    explanation: "Para formar um cluster de pontos de acesso, o modo de clustering deve estar habilitado em cada AP participante, e todos os APs devem estar conectados no mesmo segmento de rede (mesmo dominio de broadcast). Controladores separados nao sao necessarios para o clustering basico de APs. Todos devem usar o mesmo nome de cluster."
  },
  {
    id: 136,
    question: "Uma sala de aula remota acessa com sucesso aulas em video por computadores com fio. Porem, ao instalar um AP 802.11n com 25 laptops sem fio, a qualidade de audio e video fica ruim. Qual solucao sem fio melhoraria o desempenho para os laptops?",
    options: [
      "Diminuir a potencia do transmissor sem fio.",
      "Adicionar outro ponto de acesso.",
      "Atualizar o ponto de acesso para um que possa rotear.",
      "Ajustar os NICs sem fio dos laptops para operar em 10 GHz."
    ],
    correct: [1],
    multiple: false,
    explanation: "Adicionar outro ponto de acesso distribui os 25 usuarios entre os APs, reduzindo a carga em cada AP e melhorando o desempenho para streaming de video. Um unico AP 802.11n pode ser sobrecarregado com 25 usuarios acessando conteudo de alta largura de banda simultaneamente. Reduzir a potencia pioraria o alcance e o padrao 802.11n nao opera em 10 GHz."
  },
  {
    id: 137,
    question: "Qual topologia de rede sem fio esta sendo configurada por um tecnico que esta instalando um teclado, um mouse e fones de ouvido, todos usando Bluetooth?",
    options: [
      "modo ad hoc",
      "hotspot",
    ...
    correct: [0],
    multiple: false,
    explanation: "Dispositivos Bluetooth formam uma rede pessoal sem fio (WPAN) usando o modo ad hoc, onde os dispositivos se conectam diretamente entre si sem um ponto de acesso central. O modo de infraestrutura usa um AP. Hotspot refere-se a uma area com acesso sem fio a Internet. O modo misto permite que padroes antigos e recentes coexistam em um AP."
  },
  {
    id: 138,
    question: "Usuarios em uma rede IEEE 802.11n estao reclamando de velocidades lentas. O administrador de rede verifica o AP e confirma que esta operando corretamente. O que pode ser feito para melhorar o desempenho da rede sem fio?",
    options: [
      "Dividir o trafego sem fio entre a faixa de 2,4 GHz do 802.11n e a faixa de 5 GHz.",
      "Alterar o metodo de autenticacao no AP.",
      "Trocar para um AP 802.11g.",
      "Configurar o AP em modo misto."
    ],
    correct: [0],
    multiple: false,
    explanation: "O 802.11n pode operar tanto na faixa de 2,4 GHz quanto na de 5 GHz. Dividir os usuarios entre as duas faixas distribui a carga e melhora o desempenho. A faixa de 5 GHz tem menos interferencia e mais canais disponiveis. Trocar para 802.11g seria um retrocesso em velocidade. Alterar autenticacao nao afeta o throughput."
  },
  {
    id: 139,
    question: "Durante a verificacao de uma implementacao OSPFv3 de area unica nos roteadores R1, R2 e R3, observa-se que as tabelas de roteamento em R1 e R2 nao incluem a rota para uma LAN remota em R3. R3 tem enderecos corretos, processo de roteamento configurado globalmente e adjacencias corretas. Qual acao tomada no R3 poderia resolver o problema?",
    options: [
      "Habilitar o processo de roteamento OSPFv3 na interface conectada a LAN remota.",
      "Usar o comando network para configurar a rede LAN sob o processo de roteamento global.",
      "Forcar eleicoes DR/BDR onde necessario.",
      "Reiniciar o processo de roteamento OSPFv3."
    ],
    correct: [0],
    multiple: false,
    explanation: "No OSPFv3, ao contrario do OSPFv2, o OSPF e habilitado diretamente em cada interface participante usando o comando 'ipv6 ospf process-id area area-id'. Configurar o processo globalmente sem habilitar o OSPF na interface da LAN remota resulta em a rede nao ser anunciada. O comando 'network' nao e usado no OSPFv3 (e habilitado por interface)."
  },
  {
    id: 140,
    question: "Um administrador de rede quer verificar os valores de atraso (delay) padrao das interfaces em um roteador habilitado para EIGRP. Qual comando exibira esses valores?",
    options: [
      "show ip protocols",
      "show running-config",
      "show interfaces",
    ...
    correct: [2],
    multiple: false,
    explanation: "O comando 'show interfaces' exibe o valor de atraso (delay) de cada interface em microssegundos. O EIGRP usa tanto a largura de banda quanto o atraso como parte de sua metrica composta. 'show running-config' mostra apenas valores configurados manualmente (nao os padroes). 'show ip protocols' e 'show ip route' nao fornecem os valores de atraso por interface."
  },
  {
    id: 141,
    question: "Quais duas condicoes o administrador de rede deve verificar antes de tentar atualizar uma imagem do Cisco IOS usando um servidor TFTP? (Escolha duas.)",
    options: [
      "Verificar o nome do servidor TFTP usando o comando show hosts.",
      "Verificar se o servidor TFTP esta em execucao usando o comando tftpdnld.",
      "Verificar se o checksum da imagem e valido usando o comando show version.",
      "Verificar a conectividade entre o roteador e o servidor TFTP usando o comando ping.",
      "Verificar se ha espaco de flash suficiente para a nova imagem usando o comando show flash."
    ],
    correct: [3, 4],
    multiple: true,
    explanation: "Antes de uma atualizacao de IOS via TFTP e essencial: 1) Verificar a conectividade com o servidor TFTP usando ping para garantir que a transferencia sera possivel, e 2) Verificar se ha espaco suficiente na memoria flash usando 'show flash' para acomodar a nova imagem. Sem verificar ambos, a atualizacao pode falhar no meio do processo."
  },
  {
    id: 142,
    question: "Qual requisito deve ser verificado antes de um administrador de rede realizar uma atualizacao de imagem do IOS em um roteador?",
    options: [
      "O servidor FTP esta operacional.",
      "O arquivo de imagem do IOS antigo foi excluido.",
      "Ha espaco suficiente na memoria flash.",
      "O arquivo de imagem do IOS desejado foi baixado para o roteador."
    ],
    correct: [2],
    multiple: false,
    explanation: "Antes de iniciar o processo de atualizacao, o administrador deve garantir que ha espaco suficiente na flash para hospedar o novo arquivo de imagem IOS. Um arquivo IOS antigo nao precisa ser excluido desde que haja espaco disponivel. O FTP nao e suportado para atualizacao de IOS; um servidor TFTP e usado. A nova imagem deve estar no servidor TFTP, nao no roteador."
  },
  {
    id: 143,
    question: "Qual e o proposito do Cisco PAK (Product Activation Key)?",
    options: [
      "E uma chave para habilitar um conjunto de recursos (feature set) do IOS.",
      "E um algoritmo de criptografia proprietario da Cisco.",
      "E um tipo de arquivo de compressao usado ao instalar o IOS 15 ou uma atualizacao do IOS.",
      "E uma forma de compactar um IOS existente para que uma versao mais nova do IOS possa ser co-instalada em um roteador."
    ],
    correct: [0],
    multiple: false,
    explanation: "O PAK (Product Activation Key) da Cisco e uma chave usada para ativar um pacote de tecnologia especifico do IOS 15. Para ativar um conjunto de recursos, voce deve fornecer a Cisco o ID do produto do roteador com o numero de serie associado e um PAK comprado. O PAK e entao convertido em uma licenca para o dispositivo especifico."
  },
  {
    id: 144,
    question: "Qual pacote de tecnologia do Cisco IOS Software Release 15.0 e enviado com uma licenca permanente em todos os dispositivos Cisco ISR G2?",
    options: ["IPBase", "DATA", "Unified Communications", "Security"],
    correct: [0],
    multiple: false,
    explanation: "Todos os roteadores Cisco ISR G2 vem com o pacote de tecnologia IP Base instalado permanentemente sem custo adicional. Os pacotes adicionais (Data, Security e Unified Communications) requerem a compra e instalacao de licencas separadas. O IP Base fornece funcionalidades fundamentais de roteamento IP."
  },
  {
    id: 145,
    question: "Um administrador de rede emite o comando 'R1(config)# license boot module c1900 technology-package securityk9' em um roteador. Qual e o efeito deste comando?",
    options: [
      "O IOS solicitara ao usuario que reinicie o roteador.",
      "Os recursos do pacote Security ficam disponiveis imediatamente.",
      "O IOS solicitara ao usuario que forneca um UDI para ativar a licenca.",
      "A licenca Evaluation Right-To-Use para o pacote de tecnologia Security e ativada."
    ],
    correct: [3],
    multiple: false,
    explanation: "O comando 'license boot module' ativa a licenca RTU (Right-To-Use) de avaliacao para o pacote de tecnologia especificado. Isso permite usar temporariamente os recursos do pacote sem ter uma licenca permanente. O IOS ira solicitar a reinicializacao do roteador para que os novos recursos entrem em vigor."
  },
  {
    id: 146,
    question: "Quais dois estados de licenca seriam esperados em um novo roteador Cisco depois que a licenca foi ativada? (Escolha dois.)",
    options: [
    ...
    correct: [1, 3],
    multiple: true,
    explanation: "Quando o comando 'show license' e emitido apos a ativacao de uma licenca permanente, as informacoes mostradas incluem: 'License Type: Permanent' (indica que a licenca nao expira) e 'License State: Active, In Use' (indica que a licenca esta ativa e sendo usada ativamente pelo IOS). 'ipbasek9' e o nome do recurso, nao um tipo de licenca."
  },
  {
    id: 147,
    question: "Qual e uma diferenca entre as versoes Cisco IOS 12 e IOS 15?",
    options: [
      "A versao IOS 12 possui comandos que nao estao disponiveis na versao 15.",
      "A chave de licenca da versao IOS 15 e unica para cada dispositivo, enquanto a chave de licenca da versao IOS 12 nao e especifica do dispositivo.",
      "Todo roteador da plataforma Cisco ISR G2 inclui uma imagem universal nas versoes IOS 12, mas nao nas versoes IOS 15.",
      "A versao IOS 12.4(20)T1 e um release mainline, enquanto a versao IOS 15.1(1)T1 e um release de novos recursos."
    ],
    correct: [1],
    multiple: false,
    explanation: "No IOS 15, a chave de licenca e vinculada ao UDI (Unique Device Identifier) de cada dispositivo especifico, tornando-a unica por dispositivo. No IOS 12, as licencas nao eram especificas por dispositivo da mesma forma. O IOS 15 (nao o IOS 12) usa imagem universal. O IOS 12.4T e um release de novos recursos (T-Train), nao mainline."
  },
  {
    id: 148,
    question: "Um administrador de rede esta solucionando problemas de lentidao em uma rede comutada de Camada 2. Ao examinar o cabecalho IP, o administrador percebe que o valor TTL nao esta diminuindo. Por que o valor TTL nao esta diminuindo?",
    options: [
      "Este e o comportamento normal para uma rede de Camada 2.",
      "A tabela de enderecos MAC esta cheia.",
      "O banco de dados VLAN esta corrompido.",
      "A interface de entrada esta configurada para half duplex."
    ],
    correct: [0],
    multiple: false,
    explanation: "O campo TTL (Time to Live) e decrementado apenas por dispositivos de Camada 3 (roteadores). Switches de Camada 2 encaminham frames sem modificar o cabecalho IP; portanto, o TTL nao e decrementado ao passar por switches. Este e o comportamento normal e esperado em uma rede de Camada 2. A lentidao pode ter outra causa (loop de Camada 2, broadcast storm, etc.)."
  },
  {
    id: 149,
    question: "Uma instancia STP falhou e os frames estao inundando a rede. Qual acao deve ser tomada pelo administrador de rede?",
    options: [
      "Nenhuma resposta do administrador e necessaria porque o campo TTL eventualmente parara os frames de inundar a rede.",
      "O spanning tree deve ser desabilitado para aquela instancia STP ate que o problema seja localizado.",
      "O trafego de broadcast deve ser investigado e eliminado da rede.",
      "Os links redundantes devem ser fisicamente removidos ate que a instancia STP seja reparada."
    ],
    correct: [3],
    multiple: false,
    explanation: "Se a instancia STP falhou e ha um loop de Camada 2 causando inundacao, a solucao imediata e remover fisicamente os links redundantes para eliminar o loop ate que o problema com o STP seja identificado e corrigido. A Camada 2 NAO tem mecanismo TTL (diferente da Camada 3), entao os frames continuariam circulando indefinidamente sem intervencao."
  },
  {
    id: 150,
    question: "Um engenheiro de rede configura um SSID na faixa de 5 GHz para servicos de streaming em uma rede sem fio. Por que essa solucao pode melhorar o desempenho da rede sem fio para esse tipo de servico?",
    options: [
      "A faixa de 5 GHz tem maior alcance e, portanto, provavelmente estara livre de interferencias.",
      "Exigir que os usuarios mudem para a faixa de 5 GHz e inconveniente e resultara em menos usuarios acessando esses servicos.",
      "A faixa de 5 GHz tem mais canais e esta menos saturada do que a faixa de 2,4 GHz, tornando-a mais adequada para streaming de multimidia.",
      "Apenas os usuarios com os NICs sem fio mais recentes poderao mudar para a faixa de 5 GHz, o que reduzira o uso."
    ],
    correct: [2],
    multiple: false,
    explanation: "A faixa de 5 GHz oferece mais canais disponiveis (23 canais nao sobrepostos vs. 3 no 2,4 GHz) e e menos congestionada por interferencias de outros dispositivos (micro-ondas, Bluetooth, etc.). Isso a torna mais adequada para aplicacoes de streaming de video que exigem alto throughput e baixa latencia. O alcance e determinado pela potencia da antena, nao pela faixa de frequencia."
  },
  {
    id: 151,
    question: "Um administrador de rede em uma filial esta configurando autenticacao EIGRP entre o roteador da filial e o roteador da sede. Qual credencial de seguranca e necessaria para o processo de autenticacao?",
    options: [
      "uma chave gerada aleatoriamente com o comando crypto key generate rsa",
      "o nome de usuario e senha configurados no roteador da sede",
      "o nome de host do roteador da sede e uma senha comum",
      "uma chave comum configurada com o comando key-string dentro de uma cadeia de chaves (key chain)"
    ],
    correct: [3],
    multiple: false,
    explanation: "A autenticacao EIGRP usa uma cadeia de chaves (key chain) com um ID de chave e uma string de chave equivalente a uma senha. Ambos os roteadores devem ser configurados com a mesma key chain e key-string para autenticacao bem-sucedida. O EIGRP usa autenticacao MD5, nao PKI/RSA como e usado pelo SSH."
  },
  {
    id: 152,
    question: "Se uma empresa quer atualizar um roteador Cisco 2800 do IOS 12.4T, qual IOS deve ser recomendado para uma plataforma de roteador estavel?",
    options: ["12.5T", "13.1T", "14.0", "15.1M"],
    correct: [3],
    multiple: false,
    explanation: "Apos o IOS 12.4T, a Cisco passou para o esquema de numeracao IOS 15. O release 15.1M (onde M indica 'mainline' ou 'maintenance') e recomendado para ambientes de producao que buscam estabilidade de longo prazo. Os releases 'M' sao focados em correcoes de bugs e estabilidade, enquanto os releases 'T' introduzem novos recursos. Nao existem versoes 12.5T, 13.1T ou 14.0."
  },
  {
    id: 153,
    question: "Um administrador tenta configurar o EIGRP para IPv6 em um roteador e recebe uma mensagem de erro. Qual comando deve ser emitido pelo administrador antes de configurar o EIGRP para IPv6?",
    options: [
    ...
    correct: [4],
    multiple: false,
    explanation: "Antes de configurar o EIGRP para IPv6 em um roteador, o roteamento IPv6 deve ser habilitado globalmente com o comando 'ipv6 unicast-routing'. Sem esse comando, o roteador nao encaminhara pacotes IPv6 e o EIGRP para IPv6 nao pode ser configurado. Esse e um pre-requisito fundamental para qualquer protocolo de roteamento IPv6."
  },
  {
    id: 154,
    question: "Qual fator tecnologico determina o impacto de um dominio de falha?",
    options: [
      "a taxa de encaminhamento dos switches usados na camada de acesso",
      "o numero de camadas da rede hierarquica",
      "o papel do dispositivo com defeito",
      "o numero de usuarios na camada de acesso"
    ],
    correct: [2],
    multiple: false,
    explanation: "O papel do dispositivo com defeito determina o impacto do dominio de falha. Se um switch de nucleo (core) falhar, toda a rede pode ser afetada. Se um switch de acesso falhar, apenas os usuarios conectados a ele sao afetados. Por isso o design hierarquico isola falhas em dominios menores, e o tamanho do dominio de falha depende da funcao do dispositivo na hierarquia."
  },
  {
    id: 155,
    question: "Uma interface Fa0/1 do switch S1 esta no modo PAgP 'desirable' e a interface Fa0/1 do S2 esta no modo 'on'. A interface Fa0/2 do S1 esta no modo 'auto' e a interface Fa0/2 do S2 tambem esta no modo 'auto'. Quais sao dois erros nessa configuracao EtherChannel? (Escolha dois.)",
    options: [
      "O modo desirable nao e compativel com o modo on.",
      "O modo trunk nao e permitido para pacotes EtherChannel.",
      "Dois modos auto nao podem formar um pacote EtherChannel.",
      "O grupo do canal e inconsistente.",
      "O ID da interface port channel deve ser diferente em ambos os switches."
    ],
    correct: [0, 2],
    multiple: true,
    explanation: "Dois erros existem nessa configuracao: 1) O modo PAgP 'desirable' (que tenta negociar ativamente) e o modo 'on' (que nao usa protocolo de negociacao) sao incompativeis, pois 'desirable' requer PAgP ativo no outro lado; e 2) Dois modos 'auto' PAgP nao podem formar um EtherChannel porque ambos os lados aguardam passivamente que o outro inicie a negociacao — nenhum inicia."
  },
  {
    id: 156,
    question: "Quais sao dois requisitos ao usar configuracao fora de banda (out-of-band) de um dispositivo de rede Cisco IOS? (Escolha dois.)",
    options: [
      "acesso Telnet ou SSH ao dispositivo",
      "uma conexao com uma interface de rede operacional no dispositivo",
      "uma conexao direta a porta console ou AUX",
      "um cliente de emulacao de terminal",
      "acesso HTTP ao dispositivo"
    ],
    correct: [2, 3],
    multiple: true,
    explanation: "A configuracao fora de banda (out-of-band) requer acesso fisico ao dispositivo via porta console ou AUX, e um cliente de emulacao de terminal (como PuTTY ou Tera Term) no computador de gerenciamento. Acesso Telnet/SSH/HTTP sao metodos in-band que requerem uma interface de rede operacional no dispositivo — o oposto da configuracao out-of-band."
  },
  {
    id: 157,
    question: "Um roteador foi removido da rede para manutencao. Uma nova imagem de software Cisco IOS foi copiada com sucesso para a flash do roteador. O que deve ser feito antes de colocar o roteador de volta em servico?",
    options: [
      "Excluir a versao anterior do software Cisco IOS da flash.",
      "Copiar a configuracao em execucao para a NVRAM.",
      "Fazer backup da nova imagem para o servidor TFTP.",
      "Reiniciar o roteador e verificar se a nova imagem inicia com sucesso."
    ],
    correct: [3],
    multiple: false,
    explanation: "Apos copiar a nova imagem IOS para a flash, o roteador deve ser reiniciado para carregar a nova imagem. Apos a reinicializacao, o administrador deve verificar que a nova imagem foi carregada com sucesso (usando 'show version') antes de colocar o roteador de volta em servico. A imagem anterior nao precisa ser excluida se houver espaco suficiente na flash."
  },
  {
    id: 158,
    question: "Qual e o proposito de um release EM (Extended Maintenance) do Cisco IOS 15?",
    options: [
      "Especifica recursos avancados de servicos IP, como pacotes avancados de seguranca e provedor de servicos.",
      "Fornece pacotes premium e habilita combinacoes adicionais de recursos do IOS para requisitos de rede mais complexos.",
      "Fornece reconstrucoes regulares de manutencao de correcao de bugs, alem de suporte de correcao critica para bugs que afetam a rede.",
      "E usado para manutencao de longo prazo, permitindo que os clientes qualifiquem, implantem e permanecam no release por um periodo prolongado."
    ],
    correct: [3],
    multiple: false,
    explanation: "Os releases EM (Extended Maintenance) do Cisco IOS 15 sao projetados para manutencao de longo prazo e sao recomendados para ambientes de producao onde a estabilidade e o suporte prolongado sao essenciais. Empresas podem manter um release EM por anos sem precisar atualizar para versoes mais novas, recebendo apenas correcoes de seguranca e bugs criticos."
  },
  {
    id: 159,
    question: "O que ocorre quando a autenticacao e configurada em apenas um dos roteadores de um par EIGRP?",
    options: [
      "Apos a autenticacao EIGRP ser configurada, o roteador deve ser reinicializado para restabelecer adjacencias.",
      "Se as adjacencias forem exibidas apos usar o comando 'show ip eigrp neighbors', a autenticacao EIGRP foi bem-sucedida.",
      "Apenas um roteador precisa ser configurado para autenticacao EIGRP.",
      "Se apenas um roteador foi configurado para autenticacao EIGRP, quaisquer adjacencias anteriores serao perdidas."
    ],
    correct: [3],
    multiple: false,
    explanation: "A autenticacao EIGRP requer que AMBOS os roteadores estejam configurados com a mesma chave. Se apenas um roteador for configurado para autenticacao EIGRP, as adjacencias anteriores serao perdidas porque o roteador configurado exigira autenticacao dos pacotes EIGRP recebidos, mas o outro roteador nao os enviara autenticados."
  },
  {
    id: 160,
    question: "Um roteador OSPF tem tres redes diretamente conectadas: 10.0.0.0/16, 10.1.0.0/16 e 10.2.0.0/16. Qual comando OSPF anunciaria apenas a rede 10.1.0.0 para os vizinhos?",
    options: [
    ...
    correct: [0],
    multiple: false,
    explanation: "A mascara curinga 0.0.255.255 corresponde exatamente aos primeiros 16 bits (prefixo /16), identificando precisamente a rede 10.1.0.0/16 sem incluir as redes 10.0.0.0/16 ou 10.2.0.0/16. A mascara curinga e a inversao da mascara de sub-rede: 255.255.0.0 invertida = 0.0.255.255. A mascara 0.0.0.0 corresponderia exatamente a um unico IP, e 255.255.255.0 e uma mascara de sub-rede, nao curinga."
  },
  {
    id: 161,
    question: "Qual tipo de endereco o OSPFv3 usara para formar adjacencias com roteadores vizinhos?",
    options: [
      "o multicast de todos os roteadores OSPF (FF02::5)",
      "o endereco link-local da interface",
      "o multicast de todos os roteadores de link (FF02::1)",
      "o endereco unicast global da interface"
    ],
    correct: [1],
    multiple: false,
    explanation: "O OSPFv3 usa enderecos link-local (FE80::/10) como endereco de origem para mensagens OSPF e como proximo salto nas tabelas de roteamento. As adjacencias OSPFv3 sao identificadas e mantidas usando enderecos link-local das interfaces. Embora o multicast FF02::5 seja usado para descoberta de vizinhos, os enderecos link-local sao os que definem as adjacencias."
  },
  {
    id: 162,
    question: "Quais sao duas diferencas entre as versoes Cisco IOS 12 e IOS 15? (Escolha duas.)",
    options: [
      "Todo roteador da plataforma Cisco ISR G2 inclui uma imagem universal nas versoes IOS 12, mas nao nas versoes IOS 15.",
      "A chave de licenca da versao IOS 15 e unica para cada dispositivo, enquanto a chave de licenca do IOS 12 nao e especifica do dispositivo.",
      "A versao IOS 12 tem dois trains que ocorrem simultaneamente, enquanto a versao IOS 15 ainda tem dois trains, mas as versoes ocorrem em uma unica ordem sequencial.",
      "A versao IOS 12 possui comandos que nao estao disponiveis na versao 15.",
      "A versao IOS 12.4(20)T1 e um release mainline, enquanto a versao IOS 15.1(1)T1 e um release de novos recursos."
    ],
    correct: [1, 2],
    multiple: true,
    explanation: "As duas diferencas principais sao: 1) No IOS 15, a chave de licenca e vinculada ao UDI do dispositivo especifico (unica por dispositivo), enquanto no IOS 12 nao era especifica por dispositivo. 2) O IOS 12 tinha dois trains de desenvolvimento simultaneos (mainline e T-train), enquanto no IOS 15 as versoes ocorrem em uma ordem sequencial unica, simplificando o ciclo de releases."
  }
];
